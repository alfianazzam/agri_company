<section class="home-section home-parallax home-fade home-full-height" id="home">
    <div class="hero-slider">
        <ul class="slides">
            <li class="bg-dark-30 bg-dark active" style="background-image:url(assets/images/section-8.jpg);">
                <div class="titan-caption">
                    <div class="caption-content">
                        <div class="font-alt mb-30 titan-title-size-1">Hello &amp; welcome</div>
                        <div class="font-alt mb-40 titan-title-size-4">We are Agro Kreatif</div>
            ...
            <li class="bg-dark-30 bg-dark" style="background-image:url(assets/images/section-9.jpg);">
                <div class="titan-caption">
                    <div class="caption-content">
                        <div class="font-alt mb-30 titan-title-size-2">Agro Kreatif is creative multipurpose html
                            template
                            for<br />web developers who change the world</div>
